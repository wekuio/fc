...
{
  return h1._hash[0] >= h2._hash[0] || ( h1._hash[0] == h2._hash[0] &&
       ( h1._hash[1] >= h2._hash[1] || ( h1._hash[1] == h2._hash[1] &&
       ( h1._hash[2] >= h2._hash[2] || ( h1._hash[2] == h2._hash[2] &&
       ( h1._hash[3] >= h2._hash[3] || ( h1._hash[3] == h2._hash[3] &&
